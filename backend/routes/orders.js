...
router.post("/", async (req, res) => {
  try {
    ...
    // 🔹 Ambil address user dari tabel users
    ...
    // 🔹 Gunakan address user dari tabel users, kecuali kalau user mengisi manual
    const finalAddress = shippingAddress || user?.address || "Alamat belum diisi";
